...
U 1 1 5F98B276
P 5750 5750
F 0 "U3" H 5700 4161 50  0000 C CNN
F 1 "STM32F103C8Tx" H 5700 4070 50  0000 C CNN
F 2 "Package_QFP:LQFP-48_7x7mm_P0.5mm" H 5150 4350 50  0001 R CNN
F 3 "http://www.st.com/st-web-ui/static/active/en/resource/technical/document/datasheet/CD00161566.pdf" H 5750 5750 50  0001 C CNN
	1    5750 5750
	1    0    0    -1  
$EndComp
$Comp
...
F 1 "10nF" H 915 5605 50  0000 L CNN
...
U 1 1 5F9F98E0
P 800 5400
F 0 "#PWR038" H 800 5250 50  0001 C CNN
F 1 "+3.3V" H 815 5573 50  0000 C CNN
...
U 1 1 5FA0A8C4
P 3350 5650
F 0 "C14" H 3465 5696 50  0000 L CNN
F 1 "4.7uF" H 3465 5605 50  0000 L CNN
...
U 1 1 5FA0A8CA
P 3350 5400
F 0 "#PWR048" H 3350 5250 50  0001 C CNN
...
U 1 1 5FA44537
P 1250 5650
F 0 "C10" H 1365 5696 50  0000 L CNN
F 1 "10nF" H 1365 5605 50  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 1288 5500 50  0001 C CNN
...
U 1 1 5FA44543
P 1250 5900
F 0 "#PWR041" H 1250 5650 50  0001 C CNN
...
U 1 1 5FA46C53
P 1700 5650
F 0 "C11" H 1815 5696 50  0000 L CNN
F 1 "10nF" H 1815 5605 50  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 1738 5500 50  0001 C CNN
...
U 1 1 5FA46C5F
P 1700 5900
F 0 "#PWR043" H 1700 5650 50  0001 C CNN
...
U 1 1 5FA49A39
P 2100 5650
F 0 "C12" H 2215 5696 50  0000 L CNN
F 1 "10nF" H 2215 5605 50  0000 L CNN
...
F 1 "10nF" H 2615 5605 50  0000 L CNN
...
F 1 "+3.3V" H 2515 5573 50  0000 C CNN
...
U 1 1 5FA4F907
P 2500 5900
F 0 "#PWR047" H 2500 5650 50  0001 C CNN
...
U 1 1 5FA5CA9C
P 5750 3700
F 0 "#PWR053" H 5750 3550 50  0001 C CNN
...
U 1 1 5FA6B51B
P 2950 5650
F 0 "C15" H 3065 5696 50  0000 L CNN
F 1 "1uF" H 3065 5605 50  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 2988 5500 50  0001 C CNN
...
U 1 1 5FA6B521
P 2950 5400
F 0 "#PWR050" H 2950 5250 50  0001 C CNN
...
U 1 1 5FA6B527
P 2950 5900
F 0 "#PWR051" H 2950 5650 50  0001 C CNN
...
U 1 1 5FA815C4
P 5550 7500
F 0 "#PWR052" H 5550 7250 50  0001 C CNN
...
Text Notes 3750 5950 1    50   ~ 0
Must be for VDD3
Wire Notes Line
	4200 3000 7200 3000
Text Notes 6050 3250 2    50   ~ 10
STM32F103C8Tx
Wire Notes Line
	7200 550  7200 6450
Wire Wire Line
...
F2 "activate" I L 6100 2200 50 
F3 "sense" I L 6100 2300 50 
F4 "fuse" O R 6950 2250 50 
$EndSheet
$Sheet
S 6100 1600 850  300 
U 5F956034
F0 "sheet5F95602F" 50
F1 "fuse_block.sch" 50
F2 "activate" I L 6100 1700 50 
F3 "sense" I L 6100 1800 50 
F4 "fuse" O R 6950 1750 50 
$EndSheet
...
F0 "sheet5F955F69" 50
F1 "fuse_block.sch" 50
F2 "activate" I L 4600 2450 50 
F3 "sense" I L 4600 2550 50 
F4 "fuse" O R 5450 2500 50 
$EndSheet
Wire Wire Line
	4600 2550 4300 2550
Wire Wire Line
...
F0 "fuse_block" 50
F1 "fuse_block.sch" 50
F2 "activate" I L 4600 1450 50 
F3 "sense" I L 4600 1550 50 
F4 "fuse" O R 5450 1500 50 
$EndSheet
Wire Wire Line
	5450 2000 5650 2000
Wire Wire Line
...
F0 "sheet5F955EDF" 50
F1 "fuse_block.sch" 50
F2 "activate" I L 4600 1950 50 
F3 "sense" I L 4600 2050 50 
F4 "fuse" O R 5450 2000 50 
$EndSheet
